...
LAYER_NAME_PLAYER_DEATH_ZONES = "Player Death Zones"
...
class RobotEnemy(Enemy):
    def __init__(self):
        ...
        self.health = int(random.randint(150, 400))
...
class ZombieEnemy(Enemy):
    def __init__(self):
        ...
        self.health = int(random.randint(50, 200))
...
class GameView(arcade.View):
    ...
    def on_update(self, delta_time):
        ...
        self.scene.update(
            [LAYER_NAME_MOVING_PLATFORMS, LAYER_NAME_ENEMIES, LAYER_NAME_BULLETS, LAYER_NAME_PLAYER_DEATH_ZONES]
        )
        ...
        for bullet in self.scene[LAYER_NAME_BULLETS]:
            hit_list = arcade.check_for_collision_with_lists(
                ...
                [
                    ...
                    self.scene[LAYER_NAME_PLAYER_DEATH_ZONES],
                ],
            )
        ...
        for collision in player_collision_list:
            ...
            if self.scene[LAYER_NAME_ENEMIES] in collision.sprite_lists:
                ...
                self.window.show_view(game_over)
                return
            if self.scene[LAYER_NAME_PLAYER_DEATH_ZONES] in collision.sprite_lists:
                arcade.play_sound(self.game_over)
                game_over = GameOverView()
                self.window.show_view(game_over)
                return
